  ...
  <div class="kumitewasa-view">
    <div class="header">
      ...
      <div class="title-container">
        <h2 class="view-title">{{ t('home.cards.kumitewasa.title') }}</h2>
        <span class="view-subtitle">{{ t('home.cards.kumitewasa.desc') }}</span>
      </div>
    </div>
    <div class="controls">
...
import kumitewasaCsvRaw from '../../kumitewasa.csv?raw'
...
const {
  ...
  showNextCard,
  showPreviousCard
} = useTechniqueSession(kumitewasaCsvRaw)
</script>

  ...
  <div class="vocabulary-view">
    <div class="header">
      ...
      <div class="title-container">
        <h2 class="view-title">{{ t('home.cards.vocabulary.title') }}</h2>
        <span class="view-subtitle">{{ t('home.cards.vocabulary.desc') }}</span>
      </div>
    </div>
    <div class="controls">
...
import vocabularyCsvRaw from '../../vocabulary.csv?raw'
...
const {
  ...
  showNextCard,
  showPreviousCard
} = useTechniqueSession(vocabularyCsvRaw)
</script>

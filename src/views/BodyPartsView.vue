  ...
  <div class="body-parts-view">
    <div class="header">
      ...
      <div class="title-container">
        <h2 class="view-title">{{ t('home.cards.bodyParts.title') }}</h2>
        <span class="view-subtitle">{{ t('home.cards.bodyParts.desc') }}</span>
      </div>
    </div>
    <div class="controls">
...
import bodyPartsCsvRaw from '../../bodyParts.csv?raw'
...
const {
  ...
  showNextCard,
  showPreviousCard
} = useTechniqueSession(bodyPartsCsvRaw)
</script>
